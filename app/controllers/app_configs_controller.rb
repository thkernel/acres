class AppConfigsController < ApplicationController
  ...
  def create
    ...
    @app_config = current_user.build_app_config(app_config_params)
   

    respond_to do |format|
      if @app_config.save
        format.html { redirect_to dashboard_path, notice: 'App config was successfully created.' }
  ...
  private
    ...
    def app_config_params
      params.require(:app_config).permit(:name, :url,  company_attributes: [:id,  :name, :phone,  :brand ])
    end
end
