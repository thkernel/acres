...
$(document).on('turbolinks:load', function() {
    ...
    $('#stat-commission-mensuelle-producteur').DataTable({
    ...
    $('#stat-commission-mensuelle-banque').DataTable({
    ...
    $('#stat-commission-mensuelle-compagnie').DataTable({
    ...
    $('#stat-commission-mensuelle-apporteur').DataTable({
