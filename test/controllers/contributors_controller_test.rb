...
class ContributorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contributor" do
    assert_difference('Contributor.count') do
      post contributors_url, params: { contributor: { address: @contributor.address, city: @contributor.city, country: @contributor.country, email: @contributor.email, first_name: @contributor.first_name, last_name: @contributor.last_name, notes: @contributor.notes, phone: @contributor.phone } }
    end
  ...
  test "should update contributor" do
    patch contributor_url(@contributor), params: { contributor: { address: @contributor.address, city: @contributor.city, country: @contributor.country, email: @contributor.email, first_name: @contributor.first_name, last_name: @contributor.last_name, notes: @contributor.notes, phone: @contributor.phone } }
