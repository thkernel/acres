...
class CommissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commission" do
    assert_difference('Commission.count') do
      post commissions_url, params: { commission: { amount: @commission.amount, bank_name: @commission.bank_name, contributor_name: @commission.contributor_name, producer_name: @commission.producer_name } }
    end
  ...
  test "should update commission" do
    patch commission_url(@commission), params: { commission: { amount: @commission.amount, bank_name: @commission.bank_name, contributor_name: @commission.contributor_name, producer_name: @commission.producer_name } }
