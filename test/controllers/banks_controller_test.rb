...
class BanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post banks_url, params: { bank: { commission_percentage: @bank.commission_percentage, description: @bank.description, name: @bank.name } }
    end
  ...
  test "should update bank" do
    patch bank_url(@bank), params: { bank: { commission_percentage: @bank.commission_percentage, description: @bank.description, name: @bank.name } }
