...
class AppConfigsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create app_config" do
    assert_difference('AppConfig.count') do
      post app_configs_url, params: { app_config: { icon: @app_config.icon, name: @app_config.name, url: @app_config.url } }
    end
  ...
  test "should update app_config" do
    patch app_config_url(@app_config), params: { app_config: { icon: @app_config.icon, name: @app_config.name, url: @app_config.url } }
